...
export const help: Record<string, string> = {
  ...
  sessionStrategy: "How Codex sessions should be handled between heartbeats: resume the saved session, force a fresh session, or fork by starting a new session with parent-session handoff context.",
